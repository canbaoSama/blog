    ...
    <main>
      <div class="rule-card">
        ...
        <p>
          ...
          <a href="mailto:2430980019@qq.com">2430980019@qq.com</a
          >，或在下方留言区留言
        </p>
        ...
        <div class="format-wrap">
          ...
          <p>
            地址：
            <a href="https://www.canbaoSama.site"
              >https://www.canbaoSama.site</a
            >
          </p>
          <p>描述： 记录生活 记录美</p>
          <p>头像： https://s2.loli.net/2022/06/23/RmpxzgfeTXL9K7k.jpg</p>
        </div>
      </div>
